        ...
        <div className="bg-white rounded-lg overflow-hidden">
            <div className="relative">
                ...
                <button
                    ...
                    className="absolute top-1/2 left-0 transform rounded-lg -translate-y-1/2 bg-opacity-50 hover:bg-opacity-100 bg-white mx-2 p-1 rounded-full focus:outline-none"
                >
